(function(g){g.fn.toggles=function(i){var i=i||{},b={dragable:!0,clickable:!0,ontext:"ON",offtext:"OFF",on:!0,animtime:300,click:this},e;for(e in i)i.hasOwnProperty(e)&&(b[e]=i[e]);e="margin-left "+b.animtime/1E3+"s ease-in-out";var n={"-webkit-transition":e,"-moz-transition":e,transition:e},o={"-webkit-transition":"","-moz-transition":"",transition:""};this.each(function(){function e(g){c.off("mousemove");j.off("mouseleave");h.off("mouseup");0!==f?j.hasClass("active")?f<(-d+a)/2?c.trigger("toggle"):

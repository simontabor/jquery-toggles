...
a),this.c.trigger(this.b.o,a),this.h||(a=a?0:-this.i+this.g,this.a.e.stop().animate({marginLeft:a},this.b.animate)))};"function"===typeof define&&define.amd?define(["jquery"],k):k(f.jQuery||f.Zepto||f.ender||f.$||$)})(this);

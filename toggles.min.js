...
this.a.e.stop().animate({marginLeft:c},a?0:this.b.animate,this.b.easing)))};f.fn.toggles=function(b){return this.each(function(){new k(f(this),b)})}}"function"===typeof define&&define.amd?define(["jquery"],l):l(h.jQuery||h.Zepto||h.ender||h.$||$)})(this);

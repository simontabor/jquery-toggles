...
this.c.html(this.a.f)};h.prototype.k=function(){function a(a){a.target===b.a.d[0]&&b.b.drag||b.toggle()}var b=this;if(b.b.click&&(!b.b.clicker||!b.b.clicker.has(b.c).length))b.c.on("click",a);if(b.b.clicker)b.b.clicker.on("click",a);b.b.drag&&!b.h&&b.j()};h.prototype.j=function(){var a=this,b,c=(a.i-a.g)/4,e=function(d){a.c.off("mousemove");a.a.f.off("mouseleave");a.a.d.off("mouseup");!b&&a.b.click&&"mouseleave"!==d.type?a.toggle():(a.active?b<-c:b>c)?a.toggle():a.a.e.stop().animate({marginLeft:a.active?
0:-a.i+a.g},a.b.animate/2)}.bind(a),d=-a.i+a.g;a.a.d.on("mousedown",function(c){b=0;a.a.d.off("mouseup");a.a.f.off("mouseleave");var f=c.pageX;a.c.on("mousemove",a.a.d,function(c){b=c.pageX-f;a.active?(c=b,0<b&&(c=0),b<d&&(c=d)):(c=b+d,0>b&&(c=d),b>-d&&(c=0));a.a.e.css("margin-left",c)});a.a.d.on("mouseup",e);a.a.f.on("mouseleave",e)})};h.prototype.toggle=function(a){this.active!==a&&(a=this.active=!this.active,this.c.data("toggle-active",a),this.a.off.toggleClass("active",!a),this.a.on.toggleClass("active",
a),this.l.prop("checked",a),this.c.trigger(this.b.event_name,a),this.h||(a=a?0:-this.i+this.g,this.a.e.stop().animate({marginLeft:a},this.b.animate)))};"function"===typeof define&&define.amd?define(["jquery"],k):k(f.jQuery||f.Zepto||f.ender||f.$||$)})(this);
